"""Llama.cpp provider client — transparent proxy to the llama.cpp server."""
...
from gateway_service.providers.protocols import ChatCompletions, Completions, Embeddings, Responses
